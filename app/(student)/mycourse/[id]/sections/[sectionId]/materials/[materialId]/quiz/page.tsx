...
export default function QuizListPage() {
  ...
  const startNewAttempt = async (quiz: Quiz) => {
    try {
      ...
      if (result.success && result.data) {
        ...
        router.push(`/mycourse/${classId}/sections/${sectionId}/materials/${materialId}/quiz/${quiz.id}/attempt/${attemptId}`)
      } else {
  ...
  const continueAttempt = (attempt: QuizAttempt) => {
    router.push(`/mycourse/${classId}/sections/${sectionId}/materials/${materialId}/quiz/${attempt.quizId}/attempt/${attempt.id}`)
  }

  // View results
  const viewResults = (attempt: QuizAttempt) => {
    router.push(`/mycourse/${classId}/sections/${sectionId}/materials/${materialId}/quiz/${attempt.quizId}/results/${attempt.id}`)
  }
