...
export default function HomePage() {
  ...
  const stats = [
    ...
    { value: '2500+', label: 'Peserta Aktif', icon: <Users className="w-6 h-6" /> },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 bg-blue-700 rounded-xl p-6 text-white">
              <div className="space-y-4 order-2 lg:order-1">
                <div className="flex items-center gap-2 bg-blue-600 rounded-full px-3 py-1 w-fit">
                  ...
                  <span className="text-sm font-medium">Platform Belajar Premium</span>
                </div>
          ...
          <section className="w-full max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {features.map((feature, index) => (
                ...
                >
                  <div className="bg-blue-100 p-3 rounded-lg w-fit mx-auto mb-3 text-blue-700">
                    {feature.icon}
                  </div>
