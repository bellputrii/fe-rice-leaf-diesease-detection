    ...
    return (
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-4 mb-6">
          <button
            onClick={() => router.push(`/elearning/${classId}/sections/${sectionId}/materials/${materialId}/quiz/${quizId}`)}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => router.push(`/elearning/${classId}/sections/${sectionId}/materials/${materialId}/quiz/${quizId}/results/${attemptId}`)}
